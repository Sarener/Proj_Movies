...
export const DeleteMovieFavorit =({deleteProps})=>{
    ...
    useEffect(()=>{
        axios.get(USERS_URL)
            ...
            if(userFavoritesState){
                const index = userFavoritesState.favorites.findIndex(n => n.id === idMovie)
                userFavoritesState.favorites.splice(index,1)
            }
            useEffect(()=>{
